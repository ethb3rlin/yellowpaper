...
\usepackage{tikz}
\usepackage[hidelinks, unicode=true, pdftitle={Ethereum Yellow Paper: a formal specification of Ethereum, a programmable blockchain}, pdfauthor={Dr. Gavin Wood},pdfkeywords={Ethereum, Yellow Paper, blockchain, virtual machine, cryptography, decentralised, singleton, transaction, generalised}]{hyperref}
%,pagebackref=true
\usepackage[scale=2,copyright]{ccicons}
...
\newcommand{\YellowPaperVersionNumber}{7251f10 -- 2022-07-31}
...
\title[Ethereum: A Secure Decentralised Generalised Transaction Ledger]{Ethereum: A Secure Decentralised \\ Generalised Transaction Ledger\\ \tiny \textbf{{Berlin version \YellowPaperVersionNumber}}}
\author[Dr. Gavin Wood, Aeron Buchanan, Christoph Jentzsch, Yoichi Hirai, et alia]{
    Dr. Gavin Wood, Aeron Buchanan, Christoph Jentzsch, Yoichi Hirai, et alia
}
\begin{document}
...
\section*{Foreword for ETHBerlin$^3$}

Berlin has always been the city of Ether. It is home to one of the few Ethereum Foundation offices, it was the place where the first Devcon was held in 2014, it was the host of the earliest Ethereum meetups, and it is the birthplace of the Goerli testnet. Back in the day, the city's spirit reflected well in the values and the vision of the global, trustless state machine.

It's not a coincidence that this unique location hosts a community of subversive thinkers and inspired hackers, a community that created a very particular event in 2018: ETHBerlin.

The booklet you are holding is the Berlin version of the Ethereum Yellow Paper, initially authored by Dr. Gavin Wood, who was the first to formalise the Ethereum protocol specification. Here, \textit{Berlin} stands for the Berlin protocol upgrade rolled out on the Ethereum mainnet in 2021. The Berlin version of the Yellow Paper is most likely the last version to be published. The paper has seen countless co-authors and contributors and had to be deprecated in the end due to its difficulties maintaining and updating it.

This booklet is a gift to every participant of ETHBerlin$^3$ in 2022. It's not only a historical souvenir but also an acknowledgement to everyone who contributed to Ethereum in the past, not only the prominent names. It should encourage everyone to build a decentralised future.

Start today; welcome to Berlin!

\hspace*{\fill}\tiny\textsc{Department of Decentralisation, September 2022, Berlin}
...
$W_{\mathrm{base}}$ = \{{\small ADDRESS}, {\small ORIGIN}, {\small CALLER}, {\small CALLVALUE}, {\small CALLDATASIZE}, {\small CODESIZE}, {\small GASPRICE},\newline \noindent\hspace*{1cm} {\small COINBASE}, {\small TIMESTAMP}, {\small NUMBER}, {\small DIFFICULTY}, {\small GASLIMIT}, {\small CHAINID},\newline \noindent\hspace*{1cm} {\small RETURNDATASIZE}, {\small POP}, {\small PC}, {\small MSIZE}, {\small GAS}\}

$W_{\mathrm{verylow}}$ = \{{\small ADD}, {\small SUB}, {\small NOT}, {\small LT}, {\small GT}, {\small SLT}, {\small SGT}, {\small EQ}, {\small ISZERO}, {\small AND}, {\small OR}, {\small XOR}, {\small BYTE}, {\small SHL}, {\small SHR},\newline \noindent\hspace*{1cm} {\small SAR}, {\small CALLDATALOAD}, {\small MLOAD}, {\small MSTORE}, {\small MSTORE8}, {\small PUSH*}, {\small DUP*}, {\small SWAP*}\}
...
\vspace*{\fill} \normalsize
\begin{center}
  \ccLogo \ccAttribution \ccShareAlike \vspace{1em}

  Copyright Dr. Gavin Wood, co-founder of Ethereum and Parity Technologies: \url{gavin@parity.io} \vspace{1em}

  This work is licensed under a "Creative Commons Attribution-ShareAlike 4.0" license: \url{http://creativecommons.org/licenses/by-sa/4.0/} \vspace{1em}

  The layout has been optimised for print. The source is available on Github: \url{https://github.com/ethb3rlin/yellowpaper/}
\end{center}
\end{document}
